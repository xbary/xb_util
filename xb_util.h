...
extern uint8_t ahextoint(register uint8_t Ach) ICACHE_FLASH_ATTR;
extern uint8_t doubletostr(double v,char *buf) ICACHE_FLASH_ATTR;
extern double CutPrecision(volatile double val, uint8_t prec) ICACHE_FLASH_ATTR;
extern char* _itoa(int value, char* result, int base) ICACHE_FLASH_ATTR;
extern uint8_t inttoa(register int32_t value,register  char* result) ICACHE_FLASH_ATTR;
extern uint8_t inttoaw(register int32_t value, register  char* result,uint8_t Awidth,char Ach) ICACHE_FLASH_ATTR;
extern uint8_t uinttoa(register uint32_t value, register char* result) ICACHE_FLASH_ATTR;
